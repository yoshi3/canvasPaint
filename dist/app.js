...
/***/ function(module, exports, __webpack_require__) {
	...
	var Counter = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'range', min: '1', max: '50', step: '1', value: this.state.lineWidth, onChange: this.handleLineWidth }),
	      React.createElement(
	        'div',
	        null,
	      ...
	      React.createElement('input', { type: 'range', min: '1', max: '20', step: '1', value: this.state.scRange, onChange: this.handleScRange }),
	      React.createElement(
	        'div',
	        null,
	        this.state.scRange
	...
	ReactDOM.render(React.createElement(Counter, null), document.getElementById('container'));
