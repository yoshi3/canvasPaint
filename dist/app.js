...
/***/ (function(module, exports, __webpack_require__) {
	...
	c.y = rect.top * c.m;
	c.gx = function (p) {
	  return p * m - undefined.x;
	};
	c.gy = function (p) {
	  return p * m - undefined.y;
	};
	...
	var average = function average(arr, fn) {
	...
	var pointer = {
	  ...
	  executeHandler: function executeHandler(type, x, y) {
	...
	var Counter = _react2.default.createClass({
	  ...
	  handleLineWidth: function handleLineWidth(e) {
	    this.setState({
	      lineWidth: e.target.value
	    });
	    lineWidth = Number(e.target.value);
	  },
	  handleScRange: function handleScRange(e) {
	    this.setState({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'range', min: '1', max: '50', step: '1', value: this.state.lineWidth, onChange: this.handleLineWidth }),
	      _react2.default.createElement(
	        'div',
	        null,
	      ...
	      _react2.default.createElement('input', { type: 'range', min: '1', max: '20', step: '1', value: this.state.scRange, onChange: this.handleScRange }),
	      _react2.default.createElement(
	        'div',
	        null,
	        this.state.scRange
	...
	_reactDom2.default.render(_react2.default.createElement(Counter, null), document.getElementById('container'));
